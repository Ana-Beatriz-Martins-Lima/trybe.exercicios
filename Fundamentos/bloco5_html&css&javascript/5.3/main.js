...
// 1.2. Note que uma das caixas está um pouco acima das outras. Por que isso ocorre? resp: por conta da claase tech

// 2. Crie uma função que adicione a classe 'tech' ao elemento `li` quando for clicado.
// 2.1. Deve existir apenas um elemento com a classe 'tech'. Como você faz isso?
firstLi.addEventListener("click", createClass);
function createClass() {
    firstLi.setAttribute("class","tech")
}

firstLi.addEventListener("dblclick", removeClass);
...
myWebpage.addEventListener('mouseover', addClass);
...
myWebpage.addEventListener('mouseleave', resetClass);
